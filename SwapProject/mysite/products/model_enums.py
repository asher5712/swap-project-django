...
class ProductStatus(enum.Enum):
    ...
    __labels__ = {
        LIVE: gettext_lazy("Live"),
        PENDING_CHECKOUT: gettext_lazy("Pending Checkout"),
        CHECKOUT_COMPLETE: gettext_lazy("Checkout Complete"),
        COLLECTED: gettext_lazy("Collected"),
        DELIVERED: gettext_lazy("Delivered"),
    }
